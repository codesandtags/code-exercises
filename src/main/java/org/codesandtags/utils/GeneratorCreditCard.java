...
public class GeneratorCreditCard {	
	/*
	...
	public static String generateVisaCardNumber16(){
		return credit_card_number(VISA_PREFIX_LIST, 16, 1)[0];
	}
	
	public static String generateVisaCardNumber13(){
		return credit_card_number(VISA_PREFIX_LIST, 13, 1)[0];
	}
